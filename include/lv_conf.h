...
// ---- Fonts ----
// We use custom np_font_* generated by tools/build_fonts.sh, which cover
// Latin Extended-A (Latvian) + Cyrillic (Russian). Built-in Montserrat fonts
// are ASCII-only and would render Latvian/Russian as missing-glyph squares.
//
// LV_FONT_DEFAULT must point at *something* — we keep one tiny Montserrat
// for it because the LVGL theme references LV_FONT_DEFAULT during init,
// before our custom fonts are linked in.
#define LV_FONT_MONTSERRAT_8        0
#define LV_FONT_MONTSERRAT_10       0
#define LV_FONT_MONTSERRAT_12       0
#define LV_FONT_MONTSERRAT_14       1     // kept ONLY to satisfy LV_FONT_DEFAULT
