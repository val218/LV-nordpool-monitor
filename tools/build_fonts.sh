...
# Output font files to lib/np_fonts/ — a project-local library. PlatformIO
# automatically discovers libraries in lib/<name>/ via LDF when any project
# source includes one of the lib's headers. main.cpp #includes
# "np_fonts_lib.h" specifically to trigger this discovery.
#
# The lib has its own library.json with srcFilter "+<*.c>", so every .c
# file generated here gets compiled and linked.
OUT_DIR="$ROOT_DIR/lib/np_fonts"
mkdir -p "$OUT_DIR"
