...
# Output font files to lib/np_fonts/src/. PlatformIO uses the standard
# library layout: lib/<name>/src/ for sources, lib/<name>/include/ for
# public headers. PIO compiles every .c/.cpp/.S file under src/ as part
# of the library when LDF discovers it (triggered by main.cpp including
# "np_fonts_lib.h" from the lib's include/).
OUT_DIR="$ROOT_DIR/lib/np_fonts/src"
mkdir -p "$OUT_DIR"
